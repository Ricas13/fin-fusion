...
assert.deepStrictEqual(
  ...
  'Payments & Billing must expose active billing tools without retired import workflows'
);
assert.deepStrictEqual(
...
assert(expenseHeader.includes('href="/admin/billing"')&&expenseHeader.includes('href="/admin/payments/transactions"')&&expenseHeader.includes('href="/admin/payments/export"')&&expenseHeader.includes('href="/admin/provider-mappings"')&&expenseHeader.includes('href="/admin/payments/risk-policy"'),'Sibling payment tools must remain visible without retired import links');
assert(!expenseHeader.includes('/admin/payments/legacy-import')&&!expenseHeader.includes('/admin/payments/history'),'Retired import workflows must not remain in payment navigation');
...
assert(!rendered.includes('href="/admin/payments/history"'),'Retired Payment History import must not be reachable from the sidebar');
assert(!rendered.includes('href="/admin/payments/legacy-import"'),'Retired paid-user migration must not be reachable from the sidebar');

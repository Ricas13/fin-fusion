...
assert.strictEqual(policy.addressTrustedByCidrs('::ffff:10.20.0.5',['10.20.0.0/24']),true,'IPv4-mapped IPv6 did not use IPv4 trust policy');
for(const address of ['169.254.169.254','fd00:ec2::254','fe80::1']){

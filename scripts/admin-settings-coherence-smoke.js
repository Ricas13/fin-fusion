...
assert(payments.includes('payment-provider-config')&&payments.includes('${esc(provider)}-provider')&&payments.includes('Configured — leave blank to keep current value'),'inline payment provider cards and configured secrets must remain discoverable by compact enhancement');

...
assert(payments.includes('id="stripe-provider"')&&payments.includes('id="paypal-provider"')&&payments.includes('id="plisio-provider"')&&payments.includes('Configured — leave blank to keep current value'),'all active payment provider cards and configured secrets must remain discoverable by compact enhancement');

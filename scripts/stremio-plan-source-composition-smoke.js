...
assert(/url:\s*controlled\s*\|\|\s*directPlaybackUrl\(\{\s*source\s*,\s*itemId:\s*item\.Id\s*,\s*mediaSourceId:\s*media\.Id\s*\}\)/.test(externalRuntime),'external streams must point directly at their Jellyfin source');

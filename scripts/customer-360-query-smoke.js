...
assert(compactSource.includes("customerInactivity.candidates(null,{customerId})"),'Customer 360 Free activity state must reuse the canonical inactivity evaluator instead of reimplementing its boundary logic');

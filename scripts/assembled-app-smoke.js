...
for(const[method,path]of[
 ['GET','/'],['GET','/reseller'],['GET','/reseller/security'],['GET','/reseller/ledger'],['GET','/reseller/tier-change'],['GET','/reseller/sales'],['GET','/reseller/export'],
 ['POST','/reseller/billing/tier'],['POST','/account/checkout/stripe'],['POST','/account/checkout/paypal'],['GET','/account/paypal/return'],['POST','/account/stripe/portal'],
 ['GET','/admin/reseller-management'],['GET','/admin/reseller-management/:id/dunning'],['GET','/admin/reseller-tiers'],['GET','/admin/automation'],['GET','/admin/search'],['GET','/admin/events'],['GET','/admin/commerce'],
...
const duplicateCritical=[],criticalPrefixes=['/reseller','/account/checkout','/account/paypal/return','/admin/reseller-management','/admin/configuration','/admin/provisioning/drift'],grouped=new Map();

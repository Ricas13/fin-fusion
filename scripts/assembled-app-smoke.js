...
console.log(`Assembled application route contract OK (${entries.length} mounted method/routes inspected; affiliate runtime present, retired-product routes absent).`);
process.exit(0);
...
function routeEntries(stack,out=[]){
    for(const layer of stack||[]){
        ...
        if(layer.handle?.stack)routeEntries(layer.handle.stack,out);
    }
    return out;
}
...
for(const [method,path] of [
    ...
    ['POST','/account/stripe/portal'],
    ['GET','/admin/reseller-management'],
    ['GET','/admin/reseller-tiers'],

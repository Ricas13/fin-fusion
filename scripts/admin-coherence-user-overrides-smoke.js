...
assert(nav.hiddenPages['jellyfin-import']?.groupKey==='jellyfin'&&nav.hiddenPages['jellyfin-import']?.parentKey==='jellyfin-customers','Jellyfin Import must remain subordinate to the Jellyfin customer workflow');
...
assert(nav.hiddenPages['request-plan-limits']?.groupKey==='commerce'&&nav.hiddenPages['request-plan-limits']?.parentKey==='commerce-overview','Request limits must belong to Commerce policy, not integration settings');

...
assert(!jellyfinJobs.includes('c.access_paused_at'),'background reconciliation must not treat the legacy customer-wide hold summary as authoritative for subscription/lane-scoped holds');

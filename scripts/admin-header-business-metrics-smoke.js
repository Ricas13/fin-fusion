...
assert(source.includes("primaryHref:'/admin/attention'")&&source.includes("href:'/admin/commerce/orders'")&&source.includes("href:'/admin/tickets'"),'alert and inbox menus must lead to their canonical operator queues');

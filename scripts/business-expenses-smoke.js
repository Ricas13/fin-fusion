...
function row(overrides={}){return{start_date:'2024-01-31',end_date:null,recurrence:'monthly',active:true,amount_minor:1000,currency:'GBP',category:'Hosting',supplier:'Example',...overrides};}

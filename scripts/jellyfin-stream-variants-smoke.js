...
assert(admin.includes("kind==='households'?'Household choices':'Stream choices'")&&admin.includes("kind==='households'?'How")===false,'admin commercial variants must adapt labels to the product access type');

...
expect(inactivity.includes("GREATEST(\n                      ph.started_at,\n                      allocation.allocation_start_at,\n                      NOW()-(js.free_playback_window_days||' days')::interval"),'Rolling playback must use exact overlap with both the allocation and rolling-window boundaries.');

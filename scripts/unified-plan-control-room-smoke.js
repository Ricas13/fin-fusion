...
assert(planAccessSource.includes("streams: jellyfin ? int(body.streams, 1, 50, 'Concurrent streams')"), 'saving household/network settings must preserve the independent concurrent-stream cap');

...
assert(nav.includes("['billing','Billing','/admin/billing',true]"),'Billing must remain routable while being marked hidden from the left sidebar');
assert(core.includes('group.pages.filter(page=>!page[3])'),'Sidebar renderer must omit workflow pages marked hidden');

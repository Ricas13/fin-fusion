...
assert(managed.includes("fields:'Path,MediaSources,MediaStreams'"),'managed targeted lookup must return ordinary item media metadata for raw-file delivery');
...
assert(!managed.includes('/PlaybackInfo'),'managed episode resolution must remain PlaybackInfo-free');

...
assert(dashboard.includes('managed customers / configured user capacity') && dashboard.includes('controlCenter.automationHeroCard') && !dashboard.includes('Needs attention'), 'Home hero must keep unique capacity/automation state and leave intervention counts to the persistent Alerts header');

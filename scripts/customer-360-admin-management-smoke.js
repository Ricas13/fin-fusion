...
assert(compact360.includes('/change-plan?subscriptionId=')&&compact360.includes("customerLink(id,'subscriptions/revoke','Revoke a plan'")&&compact360.includes('/move-server')&&compact360.includes('/delete-customer'),'Customer 360 must expose direct plan-change, targeted subscription-revoke, server-move and permanent-delete workflows');

...
SELECT DISTINCT ON (s.customer_id)
    ...
    COALESCE(NULLIF(s.commercial_snapshot->>'currency',''),s.currency_snapshot,p.currency) AS currency_snapshot,
    ...
    COALESCE(NULLIF(s.commercial_snapshot->>'currency',''),s.currency_snapshot,p.currency) AS currency,

...
-- WhatsApp has been retired from CAPTAiNFiN. Remove all persisted channel state
-- so the database contract matches the remaining Telegram/Discord delivery paths.

...
function normalize(value={}){
  // Global lifecycle settings own execution mode only. Free inactivity thresholds
  // are configured on each media server. The historical 3 / 7 / 30 values stay
  // in this global shape as stable compatibility defaults for legacy callers.
  return{

...
function normalize(value={}){
  // Global lifecycle settings own execution mode only. Free Server thresholds
  // are persisted on each media server. The legacy threshold fields remain in
  // this normalized shape only for backward-compatible readers and defaults;
  // customer-inactivity enforcement does not source thresholds from them.
  return{

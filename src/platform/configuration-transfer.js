...
function requestedProviderMappings(document){
    return (document.configuration.directPaymentMappings||[]).filter(x=>x.active).length;
}
...
module.exports={...core,parseDocument,exportPortableConfiguration,previewImport,applyImport,normalizeDriftPolicy,normalizeRiskPolicy,normalizeAffiliatePolicy};

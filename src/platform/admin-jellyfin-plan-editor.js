...
async function loadData(plan) {
  ...
  const [affected, usage, payment, servers, libraries, discordCatalogue] = await Promise.all([
  ...
  return { plan, free, affected, usage, payment, servers, libraries, access: accessEditor.values(plan), discordCatalogue };
}
...
module.exports = { createAdminJellyfinPlanEditorRouter, loadData, page, freePlan, jellyfinPlan, discordRoleControl };

...
async function page(req){
  ...
  const ownership=`<section class="section"><div class="sectionHead"><div><h2>Where commerce work lives</h2><div class="muted">Use the page that owns the job instead of hunting through overlapping payment screens.</div></div></div><div class="quick-actions"><a class="quick-action" href="/admin/commerce/orders"><strong>Orders</strong><span>Purchases, upcoming renewals, expiry and customer commercial events</span></a><a class="quick-action" href="/admin/billing"><strong>Billing</strong><span>Missing provider links, recurring integrity, past-due state and reconciliation</span></a><a class="quick-action" href="/admin/payments"><strong>Providers</strong><span>Stripe, PayPal and Plisio credentials, webhooks, callbacks and diagnostics</span></a><a class="quick-action" href="/admin/expenses"><strong>Finance</strong><span>Transaction ledger, operating costs and profitability reporting</span></a></div></section>`;

...
async function page(req){
  ...
  return layout({siteName:runtimeSettings.siteName(),active:'commerce-overview',title:'Plans & Payments',subtitle:d.affiliateEnabled?'Payment work first, then revenue, lifecycle and affiliate service credit':'Payment work first, then revenue, subscriber movement and upcoming expiries',body,pageClass:'page-commerce'});
}

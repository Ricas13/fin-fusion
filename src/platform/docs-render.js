...
function shellSidebar({site,basePath,brandLabel,sidebar,accountNavHtml}){if(accountNavHtml)return `<aside class="docSidebar customerSidebar customerDocSidebar"><a class="docBrand" href="${esc(basePath)}"><div class="docBrandSite">${esc(site)}</div><div class="docBrandLabel">${esc(brandLabel)}</div></a>${accountNavHtml}</aside>`;return `<nav class="docSidebar"><a class="docBrand" href="${esc(basePath)}"><div class="docBrandSite">${esc(site)}</div><div class="docBrandLabel">${esc(brandLabel)}</div></a><input class="docSearch" type="search" placeholder="Search guide…" data-doc-search aria-label="Search guide"><div data-doc-nav>${sidebar}</div></nav>`;}

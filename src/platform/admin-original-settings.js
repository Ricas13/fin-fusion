...
function sectionPage(section,req,data){
    switch(section){
        case'commerce':return commerceSection(req,data);
...
function sectionTitle(section){
    switch(section){
        case'commerce':return['Settings · Commerce','Commercial catalogue, provider and reseller controls'];
        case'integrations':return['Settings · Integrations','External services and delivery channels'];
        case'security':return['Settings · Security','Registration, verification and abuse-protection controls'];
        case'advanced':return['Settings · Advanced','Low-frequency automation, drift and configuration-transfer controls'];
        case'general':default:return['Settings · General','Identity, defaults, documentation and setup entry points'];
    }
}

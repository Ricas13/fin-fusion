...
function createAdminPaymentReconciliationRouter(){const r=express.Router();
  ...
  r.get('/admin/commerce/reconciliation',reconciliationLimit,gate,(req,res)=>res.redirect(302,'/admin/commerce'));

...
const passwordRouteLimit=routeRateLimit.middleware({scope:'customer-login-password',max:60,windowSeconds:15*60,reason:'customer_login_password'});
const twoFactorRouteLimit=routeRateLimit.middleware({scope:'customer-login-2fa',max:30,windowSeconds:10*60,reason:'customer_login_2fa'});

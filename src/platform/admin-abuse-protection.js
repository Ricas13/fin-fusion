...
async function page(req){
  ...
  <div class="formGrid"><div class="formGroup"><label>Site key</label><input class="input" name="turnstileSiteKey" maxlength="200" value="${esc(cfg.siteKey||'')}" placeholder="0x4AAAA..."></div><div class="formGroup"><label>Secret key</label><input class="input" type="password" name="turnstileSecret" maxlength="500" autocomplete="new-password" placeholder="${cfg.secretConfigured?'Configured — leave blank to keep':'0x4AAAA...'}">${settingControls.toggle({name:'clearTurnstileSecret',label:'Clear stored secret',description:'Remove the encrypted Turnstile secret on save.',tone:'danger'})}</div></div>

...
const groups=Object.freeze([
  ...
  {key:'servers',label:'Servers',pages:[['servers','Servers','/admin/servers'],['libraries','Libraries','/admin/libraries'],['fleet-operations','Fleet operations','/admin/servers/operations']]},

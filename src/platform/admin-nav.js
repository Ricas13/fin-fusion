...
const groups=Object.freeze([
  ...
  {key:'settings',label:'Settings',pages:[['setup','Setup','/admin/setup'],['settings','General','/admin/settings'],['branding','Branding','/admin/settings/branding'],['operations','Operations','/admin/operations'],['abuse-protection','Abuse Protection','/admin/settings/abuse-protection'],['reseller-settings','Reseller Settings','/admin/settings/resellers'],['stremio-settings','Stremio','/admin/settings/stremio'],['configuration-transfer','Configuration Transfer','/admin/configuration'],['backups','Backups','/admin/backups'],['support-policy','Support & Legal','/admin/settings/support']]}
]);

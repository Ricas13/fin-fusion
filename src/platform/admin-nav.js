...
const groups=Object.freeze([
  ...
  {key:'commerce',label:'Commerce',pages:[['commerce-overview','Overview','/admin/commerce'],['orders','Orders','/admin/orders'],['plans','Plans','/admin/plans'],['payments','Payments','/admin/payments'],['discounts','Discounts','/admin/discounts'],['referrals','Affiliates','/admin/referrals']]},

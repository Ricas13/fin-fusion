...
const groups=Object.freeze([
  ...
  {key:'commerce',label:'Commerce',pages:[['commerce-overview','Overview','/admin/commerce'],['plans','Plans','/admin/plans'],['reseller-tiers','Reseller Plans','/admin/reseller-tiers'],['payments','Payments','/admin/payments'],['payment-reconciliation','Reconciliation','/admin/commerce/reconciliation'],['billing','Billing','/admin/billing'],['discounts','Discounts','/admin/discounts'],['referrals','Referrals','/admin/referrals']]},

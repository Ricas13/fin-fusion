...
const groups=Object.freeze([
  ...
  {key:'stremio',label:'Stremio',pages:[['stremio-overview','Overview','/admin/stremio'],['stremio-sources','Sources','/admin/servers/stremio'],['stremio-plans','Plans','/admin/plans?type=stremio'],['stremio-customers','Customers','/admin/users?service=stremio'],['stremio-playback','Household leases','/admin/stremio/playback']]},

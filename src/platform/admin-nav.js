...
const groups=Object.freeze([
  ...
  {key:'servers',label:'Delivery',pages:[['stremio-sources','Stremio','/admin/servers/stremio'],['servers-dashboard','Overview','/admin/servers/dashboard'],['servers','Jellyfin servers','/admin/servers'],['activity','Playback','/admin/activity']]},

...
const groups=Object.freeze([
  ...
  {key:'servers',label:'Delivery',pages:[['servers-dashboard','Overview','/admin/servers/dashboard'],['servers','Jellyfin servers','/admin/servers'],['stremio-sources','Stremio','/admin/servers/stremio'],['activity','Playback','/admin/activity']]},

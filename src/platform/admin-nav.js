...
const groups=Object.freeze([
  ...
  {key:'servers',label:'Servers',pages:[['servers-dashboard','Dashboard','/admin/servers/dashboard'],['servers','Servers','/admin/servers'],['libraries','Libraries','/admin/libraries'],['activity','Playback','/admin/activity'],['stremio-sources','Stremio','/admin/servers/stremio/managed'],['fleet-operations','Fleet','/admin/servers/operations']]},
...
const aliases=Object.freeze({
  'provider-mappings':'payments','notifications':'notification-settings','notification-events':'notification-settings','payment-reconciliation':'payments','configuration-health':'settings-general','setup':'settings-general','settings':'settings-general','support-policy':'settings-general','stremio-settings':'stremio-sources','stremio-source-pool':'stremio-sources','stremio-managed-sources':'stremio-sources','abuse-protection':'settings-security','security':'my-security','operations':'fleet-operations'
});

...
const groups=Object.freeze([
  ...
  {key:'settings',label:'Settings',pages:[['settings-general','General','/admin/settings?section=general'],['settings-security','Security','/admin/settings?section=security'],['settings-integrations','Connections','/admin/settings/integrations'],['settings-commerce','Commerce','/admin/settings?section=commerce'],['system','System','/admin/system']]}
]);

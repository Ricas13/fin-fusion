...
function csvField(value) {
    ...
    // Neutralize spreadsheet formula injection (OWASP CSV injection): a cell starting with
    // =, +, -, @, tab or CR can be interpreted as a formula by Excel/Sheets when opened.

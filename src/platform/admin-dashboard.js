...
function dashboardHero(ctx){
  ...
  return `<section class="profitHeroGrid" aria-label="Business and operational summary">
    ...
    <a class="profitHeroCard info" href="/admin/servers"><span>Server users / capacity</span><strong>${esc(number(active))} / ${capacity?esc(number(capacity)):'—'}</strong><div class="profitGauge" aria-hidden="true"><i style="width:${used}%"></i></div><small>managed server users / configured user capacity</small></a>

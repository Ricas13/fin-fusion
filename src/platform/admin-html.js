...
function layout(options={}){
    ...
    const scripts=notificationTestScriptFor(options)+planWorkflowScriptFor(options)+discountScriptFor(options)+'<script src="/js/operator-business-indicators.js" defer></script><script src="/js/admin-customer-operator.js" defer></script><script src="/js/admin-discord-identity.js" defer></script>';

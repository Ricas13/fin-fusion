...
async function page(req, options = {}) {
    ...
    const allSubscriptions=ui.detailDisclosure({title:`Linked recurring subscriptions (${recurring.length})`,summary:'Reference list for subscriptions that already have a real provider recurring identity, including subscriptions intentionally ending after the current period',bodyHtml:subscriptionTable(req,recurring)});

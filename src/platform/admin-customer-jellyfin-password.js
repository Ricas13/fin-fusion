...
function createAdminCustomerJellyfinPasswordRouter(){
    ...
    router.post('/admin/customer-jellyfin-password/:customerId/:accountId',async(req,res)=>{
        ...
        if(password.length<12||password.length>200)return res.redirect(supportPath+'&error='+encodeURIComponent('Jellyfin password must be between 12 and 200 characters.'));

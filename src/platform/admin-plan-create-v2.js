...
function form(req, input = {}, error = '', currency = 'GBP') {
  ...
  <div data-stremio-household ${stremio?'':'hidden'}><h3>Stremio access</h3><div class="securityNote standalone"><strong>1 Stremio household per subscription</strong><div class="subText">The installation may stream freely inside its household slot: one IPv4 address and one IPv6 /64 prefix are allowed before another same-family network is rejected.</div></div><div class="formGroup narrow"><label>Stremio network lease</label><div class="inputUnit"><input class="input" type="number" name="stremioHouseholdLeaseMinutes" min="15" max="1440" value="${esc(v.stremioHouseholdLeaseMinutes)}"><span>minutes</span></div><div class="inlineHelp">Default 240 minutes (4 hours). The lease refreshes on playback and can be reset from the customer or admin Stremio controls.</div></div></div>

...
async function enqueue(channel,{eventType,text,message=null,dedupeKey=null,destination=null,discordChannel=false,allowEveryone=false}){
    ...
    const structured=channel==='discord'?discordPayload(message):null;
...
module.exports={enqueueTelegram,enqueueDiscord,enqueueDiscordChannel,enqueueWhatsapp,deliverDue,recent,retry,claim,encryptPayload,decryptPayload,discordPayload,sendDiscordStructured,STALE_SENDING_MINUTES};

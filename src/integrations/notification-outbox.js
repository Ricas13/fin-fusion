...
module.exports={enqueueTelegram,enqueueDiscord,enqueueDiscordChannel,deliverDue,recent,retry,claim,encryptPayload,decryptPayload,structuredPayload,sendDiscordStructured,STALE_SENDING_MINUTES};

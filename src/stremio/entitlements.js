...
function internalSessionLimit(limit){return Math.max(2,Math.min(51,Number(limit||1)+1));}
...
module.exports={TOKEN_ENV,TOKEN_PREFIX,serviceType,streamLimit,internalSessionLimit,jellyfinAuthHeader,clientAuthorization,entitledSubscription,explicitSourceCount,usesSharedSources,selectServer,authenticateRestrictedUser,logoutRestrictedToken,refreshRestrictedAccess,reconcileForCustomer,reconcileSharedForCustomer,issueInstallation,revoke,current,findByInstallToken,accessToken,markUse,suspend};
...
(() => {
  ...
  function ensureSignalNodes(){
    ...
    wrap.querySelector('[data-business-read="customers"]')?.addEventListener('click',()=>{if(latestSnapshot?.csrfToken)markAreaRead('customers',latestSnapshot).catch(()=>{});});
    return wrap;
  }
